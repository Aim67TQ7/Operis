...
Live browser layout, storage non-persistence, tenant switching and membership removal have separate passing receipts in VERIFICATION.md. Expired-link recovery passed by user verification, followed by final user sign-off for review readiness. Preserve the distinction between independent test receipts and user acceptance; a successful runner or local suite alone does not establish complete browser acceptance.
