...
Live browser layout, storage non-persistence, tenant switching and membership removal have separate passing receipts in VERIFICATION.md. Actual delivered expired-link/replay checks remain pending. Do not mark the draft PR ready solely because this runner or local tests pass.
