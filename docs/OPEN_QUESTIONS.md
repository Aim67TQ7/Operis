...
| --- | --- | --- | --- |
| What Docker backend host and deployment access should be used? | Enables the API behind the deployed frontend | Frontend origin is https://operis-staging.netlify.app; API remains unavailable | Before staging sign-in |
